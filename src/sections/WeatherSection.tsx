    ...
    return (
        <>
            ...
            <h2 className="mx-auto flex w-[80%] items-center justify-between py-10">
                <button className="text-2xl text-black disabled:opacity-30" 
                onClick={() => setDayIndex(dayIndex - 1)} disabled={dayIndex === 0}>
                    ←
                </button>
                ...
                <button className="text-2xl text-black disabled:opacity-30" 
                onClick={() => setDayIndex(dayIndex + 1)} disabled={dayIndex === 2}>
                     →
                </button>
            </h2>
